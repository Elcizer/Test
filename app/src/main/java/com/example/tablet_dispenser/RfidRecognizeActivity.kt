...
import com.example.tablet_dispenser.databinding.ActivityRfidRecognizeBinding
...
class MainActivity : AppCompatActivity() {
    ...
    val binding: ActivityRfidRecognizeBinding by lazy {
        ActivityRfidRecognizeBinding.inflate(layoutInflater)
    }
